...
consonants = set([IPA.p, IPA.b, IPA.f, IPA.v, IPA.m, IPA.n, IPA.l, IPA.r, IPA.j, IPA.w, IPA.d, IPA.g, IPA.t, IPA.k]) #IPA.engma,
...
degree1 = set([IPA.p, IPA.b, IPA.f, IPA.v, IPA.d, IPA.g, IPA.t, IPA.k])
degree2 = set([IPA.m, IPA.n]) # IPA.engma
degree3 = set([IPA.l])
degree4 = set([IPA.r])
degree5 = set([IPA.j, IPA.w, IPA.i, IPA.u, IPA.I])
degree6 = set([IPA.e, IPA.o, IPA.a, IPA.epsilon, IPA.uh])
...
def word_to_speech(word):
    pass # use Amazon polly: https://eu-west-1.console.aws.amazon.com/polly/home/SynthesizeSpeech
